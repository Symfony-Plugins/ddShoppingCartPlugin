 ...
 * Each item is a ddShoppingCartItem object.
 *
 * @author     Diego D'amico <songecko@gmail.com>
 */
class ddShoppingCart
{
	protected
	$items   = array(),
	$orderId = null,
	...
	/**
	 * Returns item (ddShoppingCartItem instance) from the shopping cart or null if not found.
	 *
	...
	/**
	 * Returns all items (ddShoppingCart objects) in the shopping cart.
	 *
	 * @return array
	 */
